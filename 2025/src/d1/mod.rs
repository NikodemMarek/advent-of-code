...
pub mod tests {
    ...
    fn solution_evaluates_correctly() {
        assert_eq!(Day1::solution(TestInput::new(vec!["R50"])), 1);
        assert_eq!(Day1::solution(TestInput::new(vec!["L50"])), 1);
        assert_eq!(Day1::solution(TestInput::new(vec!["R50", "R16", "L16"])), 2);
        assert_eq!(Day1::solution(TestInput::new(vec!["R550"])), 1);
        assert_eq!(
            Day1::solution(TestInput::new(vec!["R50", "L100", "R100"])),
            3
        );
        assert_eq!(Day1::solution(TestInput::new(vec!["R25", "R15", "R10"])), 1);
        assert_eq!(Day1::solution(TestInput::new(vec!["L25", "L15", "L10"])), 1);
        assert_eq!(Day1::solution(TestInput::new(vec!["L25", "L15", "L10"])), 1);
        assert_eq!(
            Day1::solution(TestInput::new(vec![
